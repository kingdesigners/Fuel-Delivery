...
class BaseLanguage {
  ...
  String get supportType5 => getContentValueFromKey(633);
  ...
  String get urlLaunchError => getContentValueFromKey(617);
  String get cardHolder => getContentValueFromKey(618);
  String get expires => getContentValueFromKey(619);
  String get cardNumber => getContentValueFromKey(620);
  String get cardHolderName => getContentValueFromKey(621);
  String get expiry => getContentValueFromKey(622);
  String get expiryValidation => getContentValueFromKey(623);
  String get invalidExpiryDate => getContentValueFromKey(624);
  String get cvv => getContentValueFromKey(625);
  String get cvvValidation => getContentValueFromKey(626);
  String get invalidCvv => getContentValueFromKey(627);
  String get pay => getContentValueFromKey(628);
  String get paytrHistory => getContentValueFromKey(629);
  String get rateExp => getContentValueFromKey(630);
  String get unknownDeliveryman => getContentValueFromKey(631);
  String get writeYourReview => getContentValueFromKey(632);
  String get show => getContentValueFromKey(634);
  String get addSOSContacts => getContentValueFromKey(635);
  String get resolveEmergencyDialogTitle => getContentValueFromKey(636);
  String get resolveEmergencyDialogDesc => getContentValueFromKey(637);
  String get resolve => getContentValueFromKey(638);
  String get emergencyAlert => getContentValueFromKey(639);
  String get resolveEmergency => getContentValueFromKey(640);
  String get addWalletBalanceDialogValidation => getContentValueFromKey(641);
  String get noReviewMsg => getContentValueFromKey(642);
  String get rating => getContentValueFromKey(643);
}
